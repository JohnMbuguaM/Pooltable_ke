  ...
  group('ActionType', () {
    group('label', () {
      test('returns correct label for each type', () {
        ...
        expect(ActionType.throughShot.label, 'Through');
    ...
    group('isPositive', () {
      ...
      test('throughShot is positive, bothJumpedOff is not', () {
        expect(ActionType.throughShot.isPositive, true);
        expect(ActionType.bothJumpedOff.isPositive, false);
      });
    });

    group('isNeutral', () {
      test('throughShot is not neutral (it is positive)', () {
        expect(ActionType.throughShot.isNeutral, false);
      });
