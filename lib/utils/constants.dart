...
class AppConstants {
  ...
  // Ball sequence - derived from customRules.startingBall
  static List<int> get ballSequence => customRules.ballSequence;
  ...
  // Ball jump-off scoring mode (set in rules editor).
  static BallJumpOffMode get ballJumpOffMode => customRules.ballJumpOffMode;
